...
{
    [ToolboxBitmap(typeof(resfinder), "FSFormControls.Resources.DBButtonEx.bmp")]
    [DefaultEvent("Click")]
    [ToolboxItem(true)]
    [Serializable]
    public class DBButtonEx : DBUserControl, IButtonControl
    {
