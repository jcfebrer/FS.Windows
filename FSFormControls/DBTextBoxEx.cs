...
{
    [ToolboxBitmap(typeof(resfinder), "FSFormControls.Resources.DBTextBoxEx.bmp")]
    ...
    public class DBTextBoxEx : DBUserControl, ISupportInitialize
    {
        ...
        public string ToolTip
        {
            ...
            set
            {
                ...
                toolTip.SetToolTip(textbox, m_ToolTip);
            }
        }
    ...
    internal class DBTextBoxControlDesigner : ControlDesigner
    {
        public override SelectionRules SelectionRules
        {
            get
            {
                if (((DBTextBoxEx) Control).Multiline == false)
