...
{
    [ToolboxBitmap(typeof(resfinder), "FSFormControls.Resources.DBLabelEx.bmp")]
    [DefaultEvent("Click")]
    [ToolboxItem(true)]
    public class DBLabelEx : DBUserControl
    {
        ...
        public DBTextBoxEx.TypeData DataType { get; set; } = DBTextBoxEx.TypeData.All;

        [Description(
            "Indicamos el modo en que debe presentar la cadena. May?sculas / Min?sculas o inicial en may?scula resto min?scula."
        )]
        public DBTextBoxEx.TypeString Capitalize { get; set; } = DBTextBoxEx.TypeString.Normal;
        ...
        protected void dbnFormat(object sender, ConvertEventArgs e)
        {
            ...
            try
            {
                switch (DataType)
                {
                    case DBTextBoxEx.TypeData.Date:
